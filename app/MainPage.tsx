  ...
  return (
    <div className="orido_tm_intro">
      <div className="short_info">
        <Image width={1000} height={1000} src="/img/logo/logo.png" alt="" />
      ...
      <div className="demos">
        <div className="left">
          <div className="desc">
            <Image width={1000} height={1000} src="/img/intro/1.png" alt="" />
        ...
        <div className="right">
          <div className="desc">
            <Image width={1000} height={1000} src="/img/intro/2.png" alt="" />
